...
- 음식명 · 양 · 단위(g, ml, 개, 인분) · 칼로리 입력
- 영양소(단백질 · 탄수화물 · 지방)는 내장 음식 DB 조회 또는 칼로리 비율로 자동 추정
...
### 마이페이지
- 신체 정보 편집 (키 · 몸무게) — 나이 · 성별은 가입 시 입력 후 변경 불가
- **Harris-Benedict(개정) + TDEE 공식**으로 1일 칼로리 목표 자동 계산
- 목표 선택 (체중 감량 / 유지 / 벌크업)
